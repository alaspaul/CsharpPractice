...
WriteAttributeTo(__razor_helper_writer, "id", Tuple.Create(" id=\'", 7696), Tuple.Create("\'", 7723)

#line 182 "..\..MVC\Views\Registration\Registration.RegistrationForm.cshtml"
, Tuple.Create(Tuple.Create("", 7701), Tuple.Create<System.Object, System.Int32>(Html.UniqueId(descId)
...
Write(Html.Script("//ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/jquery.validate.js", "top", true, new List<KeyValuePair<string, string>>() { HtmlConstants.CrossOriginHtmlAttribute }));
...
WriteAttribute("class", Tuple.Create(" class=\"", 1526), Tuple.Create("\"", 1549)
            
            #line 38 "..\..MVC\Views\Registration\Registration.RegistrationForm.cshtml"
, Tuple.Create(Tuple.Create("", 1534), Tuple.Create<System.Object, System.Int32>(Model.CssClass
...
WriteAttribute("value", Tuple.Create(" value=\"", 2453), Tuple.Create("\"", 2527)
            
            #line 56 "..\..MVC\Views\Registration\Registration.RegistrationForm.cshtml"
       , Tuple.Create(Tuple.Create("", 2461), Tuple.Create<System.Object, System.Int32>(Url.Action("ResendConfirmationEmail", new { email = Model.Email})
...
WriteAttribute("class", Tuple.Create(" class=\"", 3196), Tuple.Create("\"", 3217)
            
            #line 74 "..\..MVC\Views\Registration\Registration.RegistrationForm.cshtml"
, Tuple.Create(Tuple.Create("", 3204), Tuple.Create<System.Object, System.Int32>(rowClass
            
            #line default
            #line hidden
, 3204), false)
, Tuple.Create(Tuple.Create(" ", 3213), Tuple.Create("m-0", 3214), true)
);

WriteLiteral(">\r\n                <div");

WriteAttribute("class", Tuple.Create(" class=\"", 3241), Tuple.Create("\"", 3258)
            
            #line 75 "..\..MVC\Views\Registration\Registration.RegistrationForm.cshtml"
, Tuple.Create(Tuple.Create("", 3249), Tuple.Create<System.Object, System.Int32>(colClass
...
WriteAttribute("href", Tuple.Create(" href=\"", 5416), Tuple.Create("\"", 5442)
            
            #line 113 "..\..MVC\Views\Registration\Registration.RegistrationForm.cshtml"
, Tuple.Create(Tuple.Create("", 5423), Tuple.Create<System.Object, System.Int32>(Model.LoginPageUrl
