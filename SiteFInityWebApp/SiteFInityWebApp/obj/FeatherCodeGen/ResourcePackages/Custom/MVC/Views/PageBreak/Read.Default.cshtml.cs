...
namespace SiteFInityWebApp.ResourcePackages.Custom.MVC.Views.PageBreak
{
    using System;
...
WriteAttribute("class", Tuple.Create(" class=\"", 495), Tuple.Create("\"", 523)
            
            #line 11 "..\..MVC\Views\PageBreak\Read.Default.cshtml"
, Tuple.Create(Tuple.Create("", 503), Tuple.Create<System.Object, System.Int32>(Model.CssClass
            
            #line default
            #line hidden
, 503), false)
, Tuple.Create(Tuple.Create(" ", 518), Tuple.Create("my-3", 519), true)
);
