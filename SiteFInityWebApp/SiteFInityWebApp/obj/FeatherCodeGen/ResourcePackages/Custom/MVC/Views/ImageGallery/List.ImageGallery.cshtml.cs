...
WriteAttribute("class", Tuple.Create(" class=\"", 585), Tuple.Create("\"", 645)
, Tuple.Create(Tuple.Create("", 593), Tuple.Create("list-unstyled", 593), true)
, Tuple.Create(Tuple.Create(" ", 606), Tuple.Create("d-flex", 607), true)
, Tuple.Create(Tuple.Create(" ", 613), Tuple.Create("flex-wrap", 614), true)
, Tuple.Create(Tuple.Create(" ", 623), Tuple.Create("gap-3", 624), true)
...
WriteAttribute("aria-label", Tuple.Create(" aria-label=\"", 646), Tuple.Create("\"", 689)
            
            #line 15 "..\..MVC\Views\ImageGallery\List.ImageGallery.cshtml"
, Tuple.Create(Tuple.Create("", 659), Tuple.Create<System.Object, System.Int32>(Html.Resource("ImageGallery")
...
WriteAttribute("href", Tuple.Create("\r\n                href=\"", 1306), Tuple.Create("\"", 1344)
            
            #line 27 "..\..MVC\Views\ImageGallery\List.ImageGallery.cshtml"
, Tuple.Create(Tuple.Create("", 1330), Tuple.Create<System.Object, System.Int32>(detailPageUrl
...
WriteAttribute("title", Tuple.Create("\r\n               title=\"", 1345), Tuple.Create("\"", 1407)
, Tuple.Create(Tuple.Create("", 1369), Tuple.Create("Go", 1369), true)
, Tuple.Create(Tuple.Create(" ", 1371), Tuple.Create("to", 1372), true)
, Tuple.Create(Tuple.Create(" ", 1374), Tuple.Create("image", 1375), true)
            
            #line 28 "..\..MVC\Views\ImageGallery\List.ImageGallery.cshtml"
, Tuple.Create(Tuple.Create(" ", 1380), Tuple.Create<System.Object, System.Int32>(item.Fields.Title
            
            #line default
            #line hidden
, 1381), false)
, Tuple.Create(Tuple.Create(" ", 1399), Tuple.Create("details", 1400), true)
);
...
WriteAttribute("src", Tuple.Create(" src=\"", 1468), Tuple.Create("\"", 1508)
            
            #line 29 "..\..MVC\Views\ImageGallery\List.ImageGallery.cshtml"
, Tuple.Create(Tuple.Create("", 1474), Tuple.Create<System.Object, System.Int32>(thumbnailViewModel.ThumbnailUrl
...
WriteAttribute("alt", Tuple.Create(" alt=\'", 1509), Tuple.Create("\'", 1607)
            
            #line 29 "..\..MVC\Views\ImageGallery\List.ImageGallery.cshtml"
                        , Tuple.Create(Tuple.Create("", 1515), Tuple.Create<System.Object, System.Int32>(System.Text.RegularExpressions.Regex.Replace(item.Fields.AlternativeText, @"[^\w\d_-]", "")
